...
public class Slave2 {
    ...
    public Slave2(String slaveId, String masterHost, int masterPort, String storageDirPath) throws IOException {
        this.slaveId = slaveId;
        this.masterHost = masterHost;
        this.masterPort = masterPort;
        this.storageDir = Paths.get(storageDirPath == null ? "./slave2-storage" : storageDirPath);
        Files.createDirectories(this.storageDir);
        loadIndexFromStorage();
    }

    public Slave2(String slaveId, String masterHost, int masterPort) throws IOException {
        this(slaveId, masterHost, masterPort, "./slave2-storage");
    }
